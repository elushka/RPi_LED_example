...
var HomePage = (function () {
    function HomePage(navCtrl, toastCtrl, peopleService) {
    ...
    HomePage.prototype.loadPeople = function (i) {
        var _this = this;
        console.log(i);
    ...
    HomePage.prototype.showLongToast = function () {
        var toast = this.toastCtrl.create({
...
var PeopleServiceProvider = (function () {
    ...
    PeopleServiceProvider.prototype.load = function (i) {
        var _this = this;
        if (this.data) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__providers_people_service_people_service__ = __webpack_require__(195);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
AppModule = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["L" /* NgModule */])({
        ...
        providers: [
            ...
            __WEBPACK_IMPORTED_MODULE_8__providers_people_service_people_service__["a" /* PeopleServiceProvider */]
        ]
    })
], AppModule);
